<div class="modal fade cstm-modal edit-modal" id="viewsubscriptiontModal" tabindex="-1"
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="addnew-dis-box">
                    ...
                    <form id="ViewSubscriptionForm" class="addnew-dis-form" action="{{route('subscriptions.add')}}" method="POST"
                        ...
                        <div class="input-box">
                            <div class="form-group">
                                <div class="formfield">
                                    <input type="text" class="form-control" name="name" id="name_detail"
                                        placeholder="Subscription Name" value="{{ old('name') }}" disabled>
                            ...
                            <div class="form-group">
                                <div class="formfield">
                                    <input  class="form-control" name="price" id='price'
                                        placeholder="Price" value="{{ old('price') }}" disabled>
                            ...
                            <div class="form-group">
                                <div class="formfield">
                                    <select class="form-control" name="interval" id="interval" disabled>
