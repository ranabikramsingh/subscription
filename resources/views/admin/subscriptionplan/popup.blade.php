        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="addnew-dis-box">
                    ...
                    <form id="addSubscriptionForm" class="addnew-dis-form" action="{{ route('subscriptions.add') }}"
                        ...
                        <div class="input-box">
                                ...
                                <div class="formfield">
                                    <select class="form-control" name="interval" id="interval">
                                        <option value="" {{ old('interval') == '' ? 'selected' : '' }}>
                                            <p style="color: #BABABA">Select Month Interval</p>
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                @error('description')
                                    <span class="invalid-txt description-error" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <button onclick="$(this).closest('form').submit()"
                            class="button primary-btn full-btn edit ajax-submit-button" id="editbutton"
